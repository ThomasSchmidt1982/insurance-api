TRUNCATE formule RESTART IDENTITY CASCADE;
TRUNCATE garantie RESTART IDENTITY CASCADE;
TRUNCATE assure RESTART IDENTITY CASCADE;
TRUNCATE remboursement RESTART IDENTITY CASCADE;
...
VALUES (1, 'Jean', 'DUPONT', 'jean.dupont@mail.com', 'FR7610107001011234567890129', 1234567891234, true, 1),
       ...
       (6, 'Pierre', 'MOREAU', 'pierre.moreau@mail.com', 'FR7630006000011234567890143', 1780345678901, true,NULL),
       ...
       (11, 'Emma', 'GARCIA', 'emma.garcia@mail.com', 'FR7630006000011234567890148', 2230890123456, false, NULL),
...
SELECT setval(pg_get_serial_sequence('assure', 'id'), (SELECT MAX(id) FROM assure));
SELECT setval(pg_get_serial_sequence('formule', 'id'), (SELECT MAX(id) FROM formule));
SELECT setval(pg_get_serial_sequence('garantie', 'id'), (SELECT MAX(id) FROM garantie));
SELECT setval(pg_get_serial_sequence('remboursement', 'id'), (SELECT MAX(id) FROM remboursement));